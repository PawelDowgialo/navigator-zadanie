...
import warszawaZdj from '../assets/warszawaZdj.png';
...
const Olsztyn = () => {
  ...
  useEffect(() => {
    const Weather = async () => {
      const res = await fetch(
        'https://api.weatherapi.com/v1/current.json?key=134ac8576a1e44719c0213252230104&q=Warsaw'
      );
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={warszawaZdj} style={styles.image}>
